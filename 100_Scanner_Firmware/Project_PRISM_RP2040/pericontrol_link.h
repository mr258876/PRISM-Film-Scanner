...
enum {
    ...
    PERICONTROL_CMD_GET_STATUS          = 0x40,
    PERICONTROL_CMD_SET_LED_LEVELS      = 0x41,
    PERICONTROL_CMD_SET_MOTOR_ENABLE    = 0x42,
    PERICONTROL_CMD_MOVE_MOTOR_STEPS    = 0x43,
    PERICONTROL_CMD_STOP_MOTOR          = 0x44,
    PERICONTROL_CMD_READ_TMC_REG        = 0x45,
    PERICONTROL_CMD_WRITE_TMC_REG       = 0x46,
    PERICONTROL_CMD_APPLY_MOTOR_CONFIG  = 0x47,
    PERICONTROL_CMD_CONFIG_LED_SYNC     = 0x48
};
