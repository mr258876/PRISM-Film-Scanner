...
enum {
    ...
    USB_CMD_ILLUMINATION_GET_STATE = 0x40,
    USB_CMD_ILLUMINATION_SET_LEVELS = 0x41,
    USB_CMD_ILLUMINATION_SET_STEADY = 0x42,
    USB_CMD_ILLUMINATION_CONFIG_SYNC = 0x43,
    USB_CMD_ILLUMINATION_SET_SYNC_PULSE = 0x44,
    USB_CMD_MOTION_GET_STATE = 0x50,
    USB_CMD_MOTION_SET_ENABLE = 0x51,
...
enum {
    ...
    USB_STATUS_RANGE_INVALID = 0xED,
    USB_STATUS_HW_ERROR = 0xEE
};
